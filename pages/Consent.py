...
st.markdown("""
1. I declare that I have been clearly informed about the nature, method and purpose of the research and about the commitment involved. I was given the opportunity to ask questions; they were all answered to my satisfaction. I was given enough time to decide whether or not to participate. 
...
3. I consent to the anonymous collection, retention and use of my data to answer the research question for this research for a duration of one year. 
...
6. I know that participation is voluntary and that I can withdraw from the research at any time. I do not have to give any reason for my decision. I realise that all data already collected if I withdraw will be deleted. 
""")
